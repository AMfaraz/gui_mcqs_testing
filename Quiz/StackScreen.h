...
namespace Quiz {
	...
	/// <summary>
	/// Summary for StackScreen
	/// </summary>
	public ref class StackScreen : public System::Windows::Forms::Form
	{
	public:
		Form^ previousScreen;
	...
	public:
		...
		StackScreen(Form^ obj, String^ rollNum, String^ batch, String^ dept)
		{
			previousScreen = obj;
			handling->addToLinkedList(L"../assets/Questions/stack.txt", linkedLink);
			previousScreen = obj;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(StackScreen::typeid));
			...
			this->previousQuestion->Click += gcnew System::EventHandler(this, &StackScreen::previousQuestion_Click);
			// 
			// nextQuestion
			// 
			...
			this->nextQuestion->Click += gcnew System::EventHandler(this, &StackScreen::nextQuestion_Click);
			// 
			// groupBox1
			// 
			...
			this->option2->CheckedChanged += gcnew System::EventHandler(this, &StackScreen::option2_CheckedChanged);
			// 
			// option4
			// 
			...
			this->option4->CheckedChanged += gcnew System::EventHandler(this, &StackScreen::option4_CheckedChanged);
			// 
			// option3
			// 
			...
			this->option3->CheckedChanged += gcnew System::EventHandler(this, &StackScreen::option3_CheckedChanged);
			// 
			// option1
			// 
			...
			this->option1->CheckedChanged += gcnew System::EventHandler(this, &StackScreen::option1_CheckedChanged);
			// 
			// Submit
			// 
			...
			this->Submit->Click += gcnew System::EventHandler(this, &StackScreen::Submit_Click);
			// 
			// groupBox2
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(205, 77);
			...
			// printDocument1
			// 
			this->printDocument1->PrintPage += gcnew System::Drawing::Printing::PrintPageEventHandler(this, &StackScreen::printDocument1_PrintPage);
			// 
			// printPreviewDialog1
			// 
			...
			this->ClientSize = System::Drawing::Size(1076, 759);
			this->Controls->Add(this->groupBox2);
			this->Name = L"StackScreen";
			this->Text = L"StackScreen";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &StackScreen::StackScreen_Load);
...
#pragma endregion
	private: System::Void StackScreen_Load(System::Object^ sender, System::EventArgs^ e) {
