...
namespace Quiz {
	...
	/// <summary>
	/// Summary for LinkedlistScreen
	/// </summary>
	public ref class LinkedlistScreen : public System::Windows::Forms::Form
	{
	public:
		Form^ previousScreen;
	...
	public: 
		   ...
		   LinkedlistScreen(Form^ obj, String^ rollNum, String^ batch, String^ dept)
		   {
			   previousScreen = obj;
			   handling->addToLinkedList(L"../assets/Questions/linkedlist.txt", linkedLink);
			   previousScreen = obj;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LinkedlistScreen::typeid));
			...
			this->groupBox2->Location = System::Drawing::Point(147, 75);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(796, 558);
			...
			this->questionLabel->Location = System::Drawing::Point(24, 15);
			...
			this->Submit->Location = System::Drawing::Point(323, 483);
			...
			this->Submit->Click += gcnew System::EventHandler(this, &LinkedlistScreen::Submit_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Size = System::Drawing::Size(748, 284);
			...
			this->option2->Location = System::Drawing::Point(625, 60);
			...
			this->option2->CheckedChanged += gcnew System::EventHandler(this, &LinkedlistScreen::option2_CheckedChanged);
			// 
			// option4
			// 
			...
			this->option4->Location = System::Drawing::Point(625, 214);
			...
			this->option4->CheckedChanged += gcnew System::EventHandler(this, &LinkedlistScreen::option4_CheckedChanged);
			// 
			// option3
			// 
			...
			this->option3->CheckedChanged += gcnew System::EventHandler(this, &LinkedlistScreen::option3_CheckedChanged);
			// 
			// option1
			// 
			...
			this->option1->CheckedChanged += gcnew System::EventHandler(this, &LinkedlistScreen::option1_CheckedChanged);
			// 
			// nextQuestion
			// 
			...
			this->nextQuestion->Location = System::Drawing::Point(677, 464);
			...
			this->nextQuestion->Click += gcnew System::EventHandler(this, &LinkedlistScreen::nextQuestion_Click);
			// 
			// previousQuestion
			// 
			...
			this->previousQuestion->Location = System::Drawing::Point(6, 464);
			...
			this->previousQuestion->Click += gcnew System::EventHandler(this, &LinkedlistScreen::previousQuestion_Click);
			// 
			// printDocument1
			// 
			this->printDocument1->PrintPage += gcnew System::Drawing::Printing::PrintPageEventHandler(this, &LinkedlistScreen::printDocument1_PrintPage);
			// 
			// printPreviewDialog1
			// 
			...
			this->ClientSize = System::Drawing::Size(1083, 725);
			this->Controls->Add(this->groupBox2);
			this->Name = L"LinkedlistScreen";
			this->Text = L"LinkedlistScreen";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &LinkedlistScreen::LinkedlistScreen_Load);
...
#pragma endregion
	private: System::Void LinkedlistScreen_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void nextQuestion_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		LinkedlistScreen_Load(sender, e);
	}
