...
namespace Quiz {
	...
	/// <summary>
	/// Summary for ArrayQuestionScreen
	/// </summary>
	public ref class ArrayQuestionScreen : public System::Windows::Forms::Form
	{
	public:
		Form^ previousScreen;
	...
	public:  
		...
		ArrayQuestionScreen(Form^ obj,String^ rollNum,String^ batch,String^ dept)
		{
			previousScreen = obj;
			handling->addToLinkedList(L"../assets/Questions/array.txt", linkedLink);
			previousScreen = obj;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ArrayQuestionScreen::typeid));
			...
			this->groupBox2->Location = System::Drawing::Point(195, 69);
			...
			this->Submit->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(237)), static_cast<System::Int32>(static_cast<System::Byte>(237)),
			...
			this->Submit->Click += gcnew System::EventHandler(this, &ArrayQuestionScreen::Submit_Click);
			// 
			// groupBox1
			// 
			...
			this->option2->CheckedChanged += gcnew System::EventHandler(this, &ArrayQuestionScreen::option2_CheckedChanged);
			// 
			// option4
			// 
			...
			this->option4->CheckedChanged += gcnew System::EventHandler(this, &ArrayQuestionScreen::option4_CheckedChanged);
			// 
			// option3
			// 
			...
			this->option3->CheckedChanged += gcnew System::EventHandler(this, &ArrayQuestionScreen::option3_CheckedChanged);
			// 
			// option1
			// 
			...
			this->option1->CheckedChanged += gcnew System::EventHandler(this, &ArrayQuestionScreen::option1_CheckedChanged);
			// 
			// nextQuestion
			// 
			...
			this->nextQuestion->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(237)), static_cast<System::Int32>(static_cast<System::Byte>(237)),
				static_cast<System::Int32>(static_cast<System::Byte>(36)));
			...
			this->nextQuestion->Click += gcnew System::EventHandler(this, &ArrayQuestionScreen::nextQuestion_Click);
			// 
			// previousQuestion
			// 
			...
			this->previousQuestion->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(237)),
				static_cast<System::Int32>(static_cast<System::Byte>(237)), static_cast<System::Int32>(static_cast<System::Byte>(36)));
			...
			this->previousQuestion->Click += gcnew System::EventHandler(this, &ArrayQuestionScreen::previousQuestion_Click);
			// 
			// printDocument1
			// 
			this->printDocument1->PrintPage += gcnew System::Drawing::Printing::PrintPageEventHandler(this, &ArrayQuestionScreen::printDocument1_PrintPage);
			// 
			// printPreviewDialog1
			// 
			...
			this->ClientSize = System::Drawing::Size(1097, 720);
			this->Controls->Add(this->groupBox2);
			this->Name = L"ArrayQuestionScreen";
			this->Text = L"ArrayQuestionScreen";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &ArrayQuestionScreen::ArrayQuestionScreen_Load);
...
//loading question
private: System::Void ArrayQuestionScreen_Load(System::Object^ sender, System::EventArgs^ e) {
...
private: System::Void nextQuestion_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	ArrayQuestionScreen_Load(sender, e);
}
